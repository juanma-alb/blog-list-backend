...
describe ('total likes', () => {
  ...
  test ('of a list with 1 blog', () => {
    ...
    const [{ likes }] = blogs
    expect (helper.totalLikes(blogs)).toBe(likes)
  })
...
describe ('favorite blogs', () => {
  ...
  test ('return most-favorite blog', () => {
    const result = helper.mostFavoritesBlog(blogs)
    const expectedBlog = {
      _id: '5a422b3a1b54a676234d17f9',
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
  ...
  test ('return author with most total likes', () => {
    ...
    expect(expectedAuthor).toEqual(result)
  })
})
